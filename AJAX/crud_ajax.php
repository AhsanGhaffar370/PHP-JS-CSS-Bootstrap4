...
<body class="ml_2 mr_2 ">
    ...
    <section class="pb_1 pt_1 con con85" id="contact_1">
        <div class=" sh_md form_grid1 pt_1 pb_2 pl_2 pr_2">
            ...
            <!-- Form Starts -->
            <form id="form1" method="post" action=crud_ajax2.php class="needs-validation1" enctype="multipart/form-data">
        ...
        <table class="table table-light table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            echo '<a href="crud_ajax.php?update_id='.$r['id'].'" class="btn btn-warning cl_w">Update</a> &nbsp &nbsp &nbsp';
                            echo '<a href="crud_ajax2.php?delete_id='.$r['id'].'" class="btn btn-danger cl_w">Delete</a> &nbsp &nbsp &nbsp';
                        ?>
                    </td>
                </tr>
                <?php  
